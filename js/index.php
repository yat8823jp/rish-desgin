				...
				<ul class="portfolio-sub">
					...
					<li class="portfolio-sub-item">
						...
						<dl class="comment">
							...
							<dd>デザイン / コーディング / JavaScript / フォーム</dd>
						</dl>
					</li><!--/.portfolio-sub-item-->
		...
		<section class="sec5" id="sec5">
			...
			<div class="check-form-slide">
				...
				<div class="content">
					...
					<form method="post" action="#sec5" class="contact-form" id="cf" name="cf">
						<dl class="form-block">
							<dt>* 会社名もしくはお名前</dt>
						...
						<input type="button" name="" class="check-bt">
					</form>
				</div><!--/content-->

				<div class="content2">
					<p class="sec-copy">下記内容で送信します。内容に誤りがないか今一度ご確認ください。</p>

					<!-- <form method="post" class="contact-form" id="cf" name="cf" action="sendmemail.php" onSubmit="return false;"> -->
					<form method="post" class="contact-form" id="cf" name="cf" onSubmit="return false;">
						<dl class="form-block check-form">
							<dt>* 会社名もしくはお名前</dt>
							<dd id="cname"></dd>
							<dt>* メールアドレス</dt>
							<dd id="cmail"></dd>
						...
						<div class="set-bt">
							<input type="button" name="" class="reset-bt">
							<input type="submit" name="" class="submit-bt">
						</div>
					</form>
				</div><!--/content2-->
