...
#
##-----------------------------------------------------------------------------------------------------------------##
if (version_compare(PHP_VERSION, '7.0.17', '>=')) {//PHP5.1.0以上の場合のみタイムゾーンを定義
...
$site_top = "http://rish-design.com";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "yat@rish-design.com";

//フォームのメールアドレス入力箇所のname属性の値（name="○○"　の○○部分）
$Email = "qmail";


print('console.log( "送信完了" )');
/*------------------------------------------------------------------------------------------------
以下スパム防止のための設定　
...
$Referer_check_domain = "rish-design.com";
...
$thanksPage = "http://rish-design.com";
...
お問い合わせありがとうございました。
数日中にご返信させていただきますので、今しばらくお待ち下さい。
...
──────────────────────
Rish-Design　川西 康人
〒581-0091 大阪府八尾市南植松町4丁目114
TEL：090- 4019 - 1196
E-mail:yat@rish-design.com
URL: http://www.rish-design.com
──────────────────────
